...
public class ClassRecord extends javax.swing.JFrame {
    ...
    try {
         ...
         tables1.addColumn("Midterm");
         tables1.addColumn("Finals");
         tables1.addColumn("Final Grade");
          ...
          String line;
            ...
            double tableFinals = Double.parseDouble(parts[3]);
             double tableFinalGrade = (tableMidterm + tableFinals) / 2;
        
          tables1.addRow(new Object[]{tableId, tableName, tableMidterm, tableFinals, tableFinalGrade});
        }
         rd.close();
    
        tables1.addRow(new Object[]{id, name, midterm, finals, finalGrade});
